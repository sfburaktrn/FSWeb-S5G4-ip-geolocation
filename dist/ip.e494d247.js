...
var alan = document.querySelector(".cards");
function mDataip(mdatas) {
  var mDatadiv = document.createElement("div");
  mDatadiv.classList.add("card");
  var mDataimg = document.createElement("img");
  mDataimg.src = mdatas.ülkebayrağı;
  mDatadiv.appendChild(mDataimg);
  var m2d = document.createElement("div");
  m2d.classList.add("card-info");
  mDatadiv.appendChild(m2d);
  var mdatah3 = document.createElement("h3");
  mdatah3.classList.add("ip");
  mdatah3.textContent = mdatas.sorgu;
  m2d.appendChild(mdatah3);
  var mdulke = document.createElement("p");
  mdulke.classList.add("ulke");
  mdulke.textContent = "".concat(mdatas.ülke, " (").concat(mdatas.ülkeKodu, ")");
  m2d.appendChild(mdulke);
  var mdeb = document.createElement("p");
  mdeb.textContent = "Enlem: ".concat(mdatas.enlem, " Boylam: ").concat(mdatas.boylam);
  m2d.appendChild(mdeb);
  var mdc = document.createElement("p");
  mdc.textContent = "\u015Eehir:  ".concat(mdatas.şehir);
  m2d.appendChild(mdc);
  var mdtime = document.createElement("p");
  mdtime.textContent = "Saat Dilimi: ".concat(mdatas.saatdilimi);
  m2d.appendChild(mdtime);
  var mdpara = document.createElement("p");
  mdpara.textContent = "Para birimi: ".concat(mdatas.parabirimi);
  m2d.appendChild(mdpara);
  var mdIsp = document.createElement("p");
  mdIsp.textContent = "ISP: ".concat(mdatas.isp);
